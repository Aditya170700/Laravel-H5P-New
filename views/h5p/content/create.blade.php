    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <form action="{{ route('h5p.store') }}" method="POST" class="form-horizontal" enctype="multipart/form-data"
                    id="laravel-h5p-form">
                    @csrf
                    ...
                    <fieldset>
                        ...
                        <div class="form-group {{ $errors->has('title') ? 'has-error' : '' }}">
                            ...
                            <div class="col-md-9">
                                <input type="text" name="title" id="laravel-h5p-title" class="form-control"
                                    placeholder="{{ trans('laravel-h5p.content.title') }}" value="{{ old('title') }}">
                                ...
                                <div class="col-md-9">
                                    ...
                                    <div class="form-control-static">
                                        ...
                                        <ul class="list-unstyled">
                                            ...
                                            <li>
                                                <label>
                                                    <input type="checkbox" name="frame" value="1"
                                                        class="h5p-visibility-toggler"
                                                        data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                        @checked(!empty($display_options[H5PCore::DISPLAY_OPTION_FRAME]))>
                                                ...
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="download" value="1"
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                            @checked(!empty($display_options[H5PCore::DISPLAY_OPTION_DOWNLOAD]))>
                                            ...
                                            @if (isset($display_options[H5PCore::DISPLAY_OPTION_EMBED]))
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="embed" value="1"
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                            @checked(!empty($display_options[H5PCore::DISPLAY_OPTION_EMBED]))>
                                            ...
                                            @if (isset($display_options[H5PCore::DISPLAY_OPTION_COPYRIGHT]))
                                                <li>
                                                    <label>
                                                        <input type="checkbox" name="copyright" value="1"
                                                            class="h5p-visibility-toggler"
                                                            data-h5p-visibility-subject-selector=".h5p-action-bar-buttons-settings"
                                                            @checked(!empty($display_options[H5PCore::DISPLAY_OPTION_COPYRIGHT]))>
